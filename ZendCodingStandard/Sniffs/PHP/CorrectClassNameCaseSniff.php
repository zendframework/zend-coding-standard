...
class CorrectClassNameCaseSniff implements PHP_CodeSniffer_Sniff
{
     ...
     * @return void
     */
    private function checkDoubleColon(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        $tokens = $phpcsFile->getTokens();
     ...
     * @return void
     */
    private function checkNew(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        $tokens = $phpcsFile->getTokens();
     ...
     * @return void
     */
    private function checkExtendsAndImplements(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        $tokens = $phpcsFile->getTokens();
     ...
     * @return void
     */
    private function error(PHP_CodeSniffer_File $phpcsFile, $start, $end, $expected, $actual)
    {
     ...
     * @return array
     */
    private function getGlobalUses(PHP_CodeSniffer_File $phpcsFile)
    {
        $tokens = $phpcsFile->getTokens();
