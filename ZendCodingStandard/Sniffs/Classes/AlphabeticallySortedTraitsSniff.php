...
class AlphabeticallySortedTraitsSniff implements PHP_CodeSniffer_Sniff
{
    /**
     * @return int[]
     */
     ...
     * @return array[]
     */
    private function getTraits(PHP_CodeSniffer_File $phpcsFile, $scopePtr)
    {
     ...
     * @return int
     */
    private function getEndOfTraitScope(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        $tokens = $phpcsFile->getTokens();
     ...
     * @return void
     */
    private function fixAlphabeticalOrder(PHP_CodeSniffer_File $phpcsFile, array $uses)
    {
        $first = reset($uses);
        $last = end($uses);
